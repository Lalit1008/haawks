...
const Hero = () => {
  return (
    ...
    <div className="flex flex-col justify-center items-center px-6 mt-16">
        ...
        <div className='flex flex-wrap justify-center gap-x-10 gap-y-4'><Fade left><a className="text-center px-6 py-3 bg-gradient-to-r from-[#F72585] to-[#7209B7] hover:from-[#7209B7] hover:to-[#F72585] text-xl text-white font-semibold drop-shadow-lg rounded-full"
