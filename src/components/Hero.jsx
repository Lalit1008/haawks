...
const Hero = () => {
  return (
    ...
    <div className="overflow-hidden flex flex-col justify-center items-center">
        ...
        <p className='text-white py-4 text-center w-1/2' style={{display: "flex", justifyContent: "center"}}>We aim to establish a secure space that instills confidence in investing in digital assets. Our platform provides essential resources to users, regardless of their level of expertise in the crypto investment realm.</p>
        </Fade>
